...
class EpubReader(UnstructuredWordDocumentLoader):
    def __init__(self, file_path: str | list[str], **unstructure_kwargs: Any) :
        super().__init__(file_path, **unstructure_kwargs, mode="elements", strategy="fast")
